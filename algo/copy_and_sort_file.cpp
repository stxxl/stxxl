...
int main(int argc, char ** argv)
{
    ...
    // fixme: RDWR for input is BAD!
    stxxl::syscall_file in_file(argv[2], stxxl::file::DIRECT | stxxl::file::RDWR);
...
#ifdef BOOST_MSVC
    typedef streamify_traits<vector_type::iterator>::stream_type input_stream_type;
#else
