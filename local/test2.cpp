...
int main()
{
    foxxll::scoped_print_timer
        timer("overall work", 600 * 1024 * 1024 * static_cast<ino64_t>(sizeof(int64_t)));
    ...
    {
        foxxll::scoped_print_timer
            timer("presort+write random numbers", 600 * 1024 * 1024 * static_cast<ino64_t>(sizeof(int64_t)));
    ...
    {
        foxxll::scoped_print_timer
            timer("read+merge random numbers", 600 * 1024 * 1024 * static_cast<ino64_t>(sizeof(int64_t)));
