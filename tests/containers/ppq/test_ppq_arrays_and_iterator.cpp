...
int run_external_array_test(size_t volume, size_t numpbs, size_t numwbs)
{
    ...
    
    {
        ...
        while (a.get_current_max().first < 5*block_size+876) {
            ...
            switch (maxround) {
            case 0: STXXL_CHECK_EQUAL(a.get_current_max().first, 131072); break;
            case 1: STXXL_CHECK_EQUAL(a.get_current_max().first, 262144); break;
            case 2: STXXL_CHECK_EQUAL(a.get_current_max().first, 393216); break;
            case 3: STXXL_CHECK_EQUAL(a.get_current_max().first, 524288); break;
            case 4: STXXL_CHECK_EQUAL(a.get_current_max().first, 655360); break;
            }
...
int run_multiway_merge(size_t volume, size_t numpbs, size_t numwbs)
{
    ...
    
    {
        ...
        stxxl::parallel::multiway_merge(seqs.begin(), seqs.end(),
