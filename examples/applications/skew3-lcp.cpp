 ...
 * \param &lcp is a reference to the container which stores the lcp array calculated by the algorithm.
 */
    ...
    public:
        ...
        build_lcp & operator++()
        {
            ...
            if (!l1_ptr->empty() && !l3_ptr->empty()) {
                ...
                delete l1_ptr; delete l2_ptr; delete l3_ptr;
            }
    ...
    public:
        ...
        build_sa & operator++()
        {
            ...
            if (!vmerge_sa_lcp->empty()) {
                ...
                delete vmerge_sa_lcp; vmerge_sa_lcp = NULL;
