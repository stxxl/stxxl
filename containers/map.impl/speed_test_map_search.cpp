/***************************************************************************
                          speed_test_map_search.cpp  -  description
                             -------------------
...
//! \file speed_test_map_search.cpp
...
//! \example containers/map/speed_test_map_search.cpp
...
/*! The search functions are tested here.\n
 ...
 int main( int argc, char* argv[] )
	{
		...
		for( int test_count = 1; test_count < argc; test_count++ )
		{
			...
			test0.test_searching( atol( argv[test_count] ) );
			test0.test_const_searching( atol( argv[test_count] ) );
			...
			test512.test_searching( atol( argv[test_count] ) );
			test512.test_const_searching( atol( argv[test_count] ) );
			...
			test262144.test_searching( atol( argv[test_count] ) );
			test262144.test_const_searching( atol( argv[test_count] ) );
		}
	}
