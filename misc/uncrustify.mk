...
SUBDIRS		+= $(foreach d, algo common compat containers containers/btree containers/hash_map io mng stream utils, include/stxxl/bits/$d)
SUBDIRS		+= algo common containers containers/btree containers/hash_map io mng stream utils contrib
